...
def create_root_agent(
    ...
    return Agent(
        ...
        instruction=(
            ...
            "that file and retrieve its ID. Then pass that ID to the relevant specialist agent. "
            "NEVER ask the user to provide an ID or URL — always resolve names automatically.\n\n"
