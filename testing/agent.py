...
def create_root_agent(
    ...
    return Agent(
        ...
        instruction=(
            ...
            "  5. For ANY email compose/send/write/draft request: instruct gmail_agent "
            "to run the 3-step style-selection flow (ask style → compose preview → "
            "confirm before sending) BEFORE composing the email body, UNLESS the "
            "user's message already contains a style keyword such as: "
            "normal, office, decorated, formal, casual, html, plain text, style 1, "
            "style 2, or style 3.\n\n"
