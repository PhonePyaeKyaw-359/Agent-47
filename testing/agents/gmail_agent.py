...
def create_gmail_agent(workspace_mcp: MCPToolset) -> Agent:
    ...
    instruction=(
        ...
        "    3. Sender name — how the user wants to be called / sign off as\n"
        ...
        "  Once you have to + reason + sender name, compose the full email in a formal-but-friendly\n"
        "  style (plain text, opens 'Dear <recipient>,', closes 'Best regards, <sender name>') and show a\n"
