  ...
  attachments: z
    .array(
      z.object({
        ...
        content: z
          .string()
          .describe('Base64-encoded attachment content.'),
        contentType: z
          .string()
          .optional()
    ...
    .optional()
    .describe('Local file attachments as base64 content.'),
};
          ...
          .array(
            z.object({
              ...
              style: z
                .string()
                .describe(
                  'The formatting style to apply. Supported: bold, italic, underline, strikethrough, code, link, bullet, title, subtitle, titleSpacing, subtitleSpacing, sectionSpacing, bodySpacing, bulletSpacing, heading1, heading2, heading3, heading4, heading5, heading6, normalText.',
                ),
              url: z
                .string()
                .optional()
    ...
    'calendar.createEvent',
    {
      ...
      inputSchema: {
        ...
        attendees: z
          .union([z.string(), z.array(z.string())])
          .optional()
          .describe('The email addresses of the attendees (can be a single string or an array of strings).'),
        sendUpdates: z
