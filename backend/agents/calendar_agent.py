...
def create_calendar_agent(workspace_mcp: MCPToolset) -> Agent:
    ...
    instruction=(
        ...
        "RULES:\n"
        "  - DETAILED DESCRIPTION: When creating or updating an event, use the description field as a detailed notes section for the event. Explain the full context and instructions. Structure it like this (include relevant parts based on user input):\n"
