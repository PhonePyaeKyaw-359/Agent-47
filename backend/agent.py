...
def create_root_agent(
    ...
    return Agent(
        ...
        instruction=(
            ...
            "  8. PROGRESSIVE DISCLOSURE RULE (CRITICAL): For the 6 specific tasks below, DO NOT execute the final write action. Instead, output a JSON block wrapped in triple-backtick with the word 'json intent' on the opening line. Wait for the user to confirm via a message starting with '[SYSTEM: EXECUTE_INTENT]'.\n"
            "     The 6 tasks are:\n"
            ...
            "       F. schedule_event: Output { \"intent\": \"schedule_event\", \"payload\": { \"title\": \"\", \"date\": \"\", \"start_time\": \"\", \"duration\": \"1 hour\", \"attendees\": \"\", \"description\": \"\", \"add_google_meet\": \"No\" } }\n"
